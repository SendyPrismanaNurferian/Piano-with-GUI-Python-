...
font = pygame.font.Font('Your Font', 48)
#the below is the declaration for the different size of fonts that we are going to use
#and you can change the font size and font family for your GUI Piano
medium_font = pygame.font.Font('Your Font', 28)
small_font = pygame.font.Font('Your Font', 16)
real_small_font = pygame.font.Font('Your Font', 10)
fps = 60
